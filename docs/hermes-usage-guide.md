...
> 适用版本：apexnova-connect v0.5.0 · Hermes Agent ≥0.21.0
> 平台：Linux（含 WSL2）。Hermes 本身也支持 macOS 且没有原生 Windows 版，但 macOS 不在本项目的支持范围内，见 [ADR 0024](decisions/0024-narrow-platform-claims.md)
